function authenticate(helper, paramsValues, credentials) {
    ...
    var tokenUrl = paramsValues.get("Token URL");
    var csrfTokenName = paramsValues.get("CSRF Field");
    var csrfTokenValue = extractInputFieldValue(getPageContent(helper, tokenUrl), csrfTokenName);
...
function getRequiredParamsNames() {
    return [ "Login URL", "Token URL", "CSRF Field", "POST Data" ];
}
